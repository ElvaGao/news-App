...
mui.plusReady(function(){
	...
	var newsWV = newUrlWebview("https://www.baidu.com/","news",40,50,self);
	...
	var commentWV = newUrlWebview("articleAndroidInner.html","articleAndroidInner.html",(screenHeight),0,self);
	...
	var str = "window.onscroll = function(){\
		...
		var scrollTopTo = height2-document.body.scrollTop-screenHeight;\
		if(scrollTopTo<10){\
			setTimeout(function(){\
